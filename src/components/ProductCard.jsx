...
const ProductCard = ({ dt }) => {
  ...
  return (
    <div className='w-[200px] h-[200px] relative m-2 rounded-md'>
      ...
      <div onClick={() => setOpenEdit(!openEdit)} className='absolute top-0 right-2 rounded-sm'>
        <BsThreeDots size={24} color='white' />
      </div>

      {openEdit && (
        <div className='bg-black border absolute border-white text-white top-5 right-2 p-2 text-sm'>
